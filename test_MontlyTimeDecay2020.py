...
#MonthlyTimeDecay2020 test for CZK

#Model_TimeDecay
driver.find_element(By.CSS_SELECTOR, "button[id='attributionButton'] span[class='mat-button-wrapper']").click() #open the menu
driver.find_element(By.XPATH, "(//span[@class='mat-radio-inner-circle'])[3]").click() #choose the option TimeDecay, in brackets we can change our option 1,2,3,4
time.sleep(3)
