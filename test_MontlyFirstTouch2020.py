...
#MonthlyFirstTouch2020 test for CZK

#Model_FirstTouch
driver.find_element(By.CSS_SELECTOR, "button[id='attributionButton'] span[class='mat-button-wrapper']").click() #open the menu
driver.find_element(By.XPATH, "(//span[@class='mat-radio-inner-circle'])[1]").click() #choose the option First Touch, in brackets we can change our option 1,2,3,4
time.sleep(3)
...
driver.find_element(By.XPATH, "//div[@class='cdk-overlay-container']//button[3]").click() #choose the option, in brackets we can change our option 1,2,3
...
#MonthlyFirstTouch2020 test for EUR
wait = WebDriverWait(driver, 18)
wait.until(expected_conditions.visibility_of_element_located((By.CSS_SELECTOR, "button[id='attributionButton'] span:nth-child(1)")))
time.sleep(16)
...
#Model_FirstTouch
driver.find_element(By.CSS_SELECTOR, "button[id='attributionButton'] span[class='mat-button-wrapper']").click()
driver.find_element(By.XPATH, "(//span[@class='mat-radio-inner-circle'])[1]").click()
time.sleep(3)
driver.find_element(By.XPATH, "(//div[@class='cdk-overlay-backdrop mat-overlay-transparent-backdrop cdk-overlay-backdrop-showing'])[1]").click()


#Granularity_Monthly
driver.find_element(By.CSS_SELECTOR, "roi-granularity-picker[class='ng-star-inserted'] span[class='mat-button-wrapper']").click()
driver.find_element(By.XPATH, "//div[@class='cdk-overlay-container']//button[3]").click()
