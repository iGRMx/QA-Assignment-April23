...
#DailyFirstTouch2020 test for CZK
...
driver.find_element(By.XPATH, "//div[@class='cdk-overlay-container']//button[1]").click() #choose the option, in brackets we can change our option 1,2,3
...
#DailyFirstTouch2020 test for EUR
wait = WebDriverWait(driver, 18)
wait.until(expected_conditions.visibility_of_element_located((By.CSS_SELECTOR, "button[id='attributionButton'] span:nth-child(1)")))
time.sleep(16)
...
driver.find_element(By.XPATH, "//div[@class='cdk-overlay-container']//button[1]").click()
